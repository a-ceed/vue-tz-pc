  ...
  <main id="vote-container" class="ms-container">
    <div class="ms-section__block">
      <div class="ms-page-title">
        <h2 class="page-header">{{ $t('Обратная связь') }}</h2>
        <div class="page-desc">{{ $t('Принимаем ваши отзывы и предложения') }}</div>
      </div>
    </div>
    <!-- Page Content -->
    <div class="ms-section__block">
      <div id="ms-blog-post" class="row">
        <div class="col-md-8">
          <!-- Form -->
          <form id="form" action="https://docs.google.com/forms/d/e/1FAIpQLSfZeaEHdttTKdEWQD_SgQ3Uk55d3w7wR02f9JMI-XNJ9671VQ/formResponse"
                method="post" target="hidden_iframe" onsubmit="submitted=true;">
            <div class="row">
              <div id="info"></div>

              <div class="form-group col-md-12">
                <input name="entry.1809082168" type="text" class="form-control" id="cl" :placeholder="$t('Ваше имя')" autocomplete="off">
              </div>
              <div class="form-group col-md-12">
                <input name="entry.85196393" type="email" class="form-control" :placeholder="$t('Электронная почта')">
              </div>
              <div class="form-group col-md-12">
                <input name="entry.877354490" type="text" class="form-control counrty-form" :placeholder="$t('Ваша страна')" autocomplete="off">
              </div>
              <div class="form-group col-md-12">
                <textarea name="entry.1533863879" class="form-control" id="message" :placeholder="$t('Сообщение')"></textarea>
              </div>
              <div class="col-md-12">
                <div class="formname">
